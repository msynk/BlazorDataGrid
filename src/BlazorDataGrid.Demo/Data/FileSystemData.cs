...
public static class FileSystemData
{
    ...
    public static List<FileNode> Build()
    {
        ...
        {
            Folder("src",
                Folder("BlazorDataGrid",
                    File("BlazorDataGrid.razor", 24_500),
                    File("BlazorDataGrid.razor.cs", 41_200),
                    Folder("Models",
                        File("BlazorDataGridColumnAlign.cs", 320),
                        File("BlazorDataGridSortDescriptor.cs", 540),
                        File("BlazorDataGridFilterOperator.cs", 610)),
                    Folder("Infrastructure",
                        File("BlazorDataGridDataProcessor.cs", 8_900),
                        File("BlazorDataGridPropertyAccessor.cs", 3_400))),
                Folder("BlazorDataGrid.Demo",
